package com.example.app_study_flee_market.mypage
...
import com.example.app_study_flee_market.databinding.FragmentMyPageBinding
                ...
                auth.createUserWithEmailAndPassword(email, password)
                    .addOnCompleteListener(requireActivity()) { task ->
                        if (task.isSuccessful) {
                            ...
                            Toast.makeText(context, "회원가입에 실패했습니다. 이미 가입한 이메일?", Toast.LENGTH_SHORT).show()
                        }
                    }
            }
        }
